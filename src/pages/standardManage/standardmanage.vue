<template>
    <div class="standardmanage">
        <el-tabs type="border-card"  v-model="activeName2"   @tab-click="handleClick">
            ...
            <span  slot="label"><i class="iconfont icon-kaotibiaozhun" ></i>考题标准</span>
            </el-tab-pane> 
            <el-tab-pane name="second">
            <span  slot="label"><i class="iconfont icon-kaotibiaozhunmoban" ></i>考题标准模板</span>
            </el-tab-pane> 
        </el-tabs>
